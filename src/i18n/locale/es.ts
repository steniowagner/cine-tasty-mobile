...
export const es: Locale = {
  ...
  famousDetails: {
    ...
    castTVShows: 'Participación en series',
    error: {
      description: 'Algo salió mal',
      suggestion: 'Por favor, inténtelo de nuevo más tarde',
      title: 'Oops...',
  ...
  tvShowDetails: {
    ...
    episodeRuntime: 'Duración de los episodios',
    originalCountry: 'País de origen',
    firstAirDate: 'Lanzamiento',
    lastAirDate: 'Última exposición',
    crew: 'Equipo de la serie ',
