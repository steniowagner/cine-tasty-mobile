...
jest.mock('react-native/Libraries/Utilities/Platform', () => ({
  select: ({ android }: Record<PlatformOSType, any>) => android,
  OS: 'android',
}));
...
describe('Providers/TMDBImageQualities - Android # large', () => {
  const elements = {
  ...
  describe('When the "OS" is "Android" and the "screen-classification" is "large"', () => {
    describe('When the quality selected is "low"', () => {
    ...
    describe('When the quality selected is "medium"', () => {
    ...
    describe('When the quality selected is "high"', () => {
    ...
    describe('When the quality selected is "veryHigh"', () => {
