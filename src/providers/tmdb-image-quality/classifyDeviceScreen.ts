...
const makeIOSScreenClassification = (): Types.DeviceScreenClassification => {
...
const makeAndroidScreenClassification =
...
export const classifyDeviceScreen = () => {
  return Platform.select({
    android: makeAndroidScreenClassification(),
    ios: makeIOSScreenClassification(),
  });
};
