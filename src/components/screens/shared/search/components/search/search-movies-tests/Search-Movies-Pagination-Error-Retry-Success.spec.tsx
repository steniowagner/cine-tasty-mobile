...
const I18N_MOVIE_QUERY_BY_PAGINATION_ERROR_REF = 'i18nFamousQueryByPaginationErrorRef';
const I18N_MOVIE_QUERY_BY_TEXT_ERROR_REF = 'i18nFamousQueryByTextErrorRef';
