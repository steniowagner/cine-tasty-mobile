...
import { PinchGestureHandler, gestureHandlerRootHOC } from 'react-native-gesture-handler';
...
const ImagesGalleryListItemComponent = gestureHandlerRootHOC(ImagesGalleryListItem);
