...
import * as searchTvShowsFixtures from '@mocks/fixtures/search-tv-shows';
...
const PARAMS = {
  ...
  searchByTextError: Translations.Tags.HOME_SEARCH_TV_SHOW_QUERY_BY_TEXT_ERROR,
  paginationError: Translations.Tags.HOME_SEARCH_TV_SHOW_PAGINATION_ERROR,
  placeholder: Translations.Tags.HOME_SEARCH_TV_SHOW_PLACEHOLDER,
};
...
const renderSearchMedia = (params: RenderSearchMediaParams) => {
          ...
          <AlertMessageProvider>
            <SearchMedia
              route={{
                ...
                key: `${Routes.Home.SEARCH_TV_SHOW}-key`,
                params: PARAMS,
              }}
              navigation={{
                ...navigation,
  ...
  return (
    <MockedNavigation
      ...
      extraScreens={[Routes.Home.TV_SHOW_DETAILS]}
    />
  );
};

describe('<SearchMedia /> - TV-Show', () => {
  const elements = {
  ...
  describe('Rendering', () => {
    ...
    it('should render correctly in the "default-state"', async () => {
      const resolvers = searchTvShowsFixtures.makeEntryQuerySuccessResolver({});
  ...
  describe('Pressing items', () => {
    ...
    it('should call "navigation.navigate" correctly when the user select some item from the "media-list"', () => {
      ...
      const numberOfItems = randomPositiveNumber(10, 1);
      const items =
        searchTvShowsFixtures.searchTVShowsResultItems(numberOfItems);
  ...
  describe('When paginate succesfully', () => {
    ...
    it('should render correctly the "pagination-state"', async () => {
      ...
      const component = render(
        renderSearchMedia({
          resolvers: searchTvShowsFixtures.makePaginationSuccessResolver({
            query,
          }),
        }),
      );
    ...
    it('should show items from both first and second queries', async () => {
      ...
      const entryQueryItems = searchTvShowsFixtures.searchTVShowsResultItems(
        numberOfEntryQueryItems,
      );
      const paginationItems = searchTvShowsFixtures.searchTVShowsResultItems(
    ...
    describe('Entry query', () => {
      describe('When the error is a "GraphQL-error"', () => {
        ...
        it('should show the "top-reload" button', async () => {
          ...
          const component = render(
            renderSearchMedia({
              resolvers: searchTvShowsFixtures.makeEntryGraphQLError({
                query,
              }),
            }),
          );
      ...
      describe('When the error is a "Network-error"', () => {
        ...
        it('should show the "top-reload" button', async () => {
          ...
          const component = render(
            renderSearchMedia({
              resolvers: searchTvShowsFixtures.makeEntryNetowrkError({
                query,
              }),
            }),
          );
    ...
    describe('Pagination', () => {
      describe('When the error is a "GraphQL-error"', () => {
        ...
        it('should show the "footer-reload" button', async () => {
          ...
          const component = render(
            renderSearchMedia({
              resolvers: searchTvShowsFixtures.makePaginationGraphQLError({
                query,
              }),
            }),
          );
      ...
      describe('When the error is a "Network-error"', () => {
        ...
        it('should show the "footer-reload" button', async () => {
          ...
          const component = render(
            renderSearchMedia({
              resolvers: searchTvShowsFixtures.makePaginationNetworkError({
                query,
              }),
            }),
          );
